...
var WSSecurity = /** @class */ (function () {
    ...
    WSSecurity.prototype.toXML = function () {
        ...
        var password;
        var nonce;
        var rawNonce = created + Math.random();
        ...
        if (this._passwordType === 'PasswordText') {
            ...
            password = '<wsse:Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordDigest">' + utils_1.passwordDigest(rawNonce, created, this._password) + '</wsse:Password>' +
